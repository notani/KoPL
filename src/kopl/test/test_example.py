...
example_kb = {
    "concepts": {
        "Q13393265": {"name": "basketball team", "subclassOf": ["Q12973014"]},
        "Q12973014": {"name": "sports team", "subclassOf": []},
        "Q3665646": {"name": "basketball player", "subclassOf": ["Q2066131"]},
        "Q2066131": {"name": "athlete", "subclassOf": []},
    },
    "entities": {
        "Q36159": {
            "name": "LeBron James",
            ...
            "attributes": [
                {
                    "key": "height",
                    "value": {"type": "quantity", "value": 206, "unit": "centimetre"},
                    "qualifiers": {},
                },
                {
                    "key": "work period (start)",
                    "value": {"type": "year", "value": 2003},
                    "qualifiers": {},
                },
                {
                    "key": "sex or gender",
                    "value": {"type": "string", "value": "male"},
                    "qualifiers": {},
                },
                {
                    "key": "date of birth",
                    "value": {"type": "date", "value": "1984-12-30"},
                    "qualifiers": {},
                },
            ],
            "relations": [
                ...
                },
                {
                    ...
                    "object": "Q162990",
                    "qualifiers": {
                        "point in time": [{"type": "date", "value": "2003-06-26"}]
                    },
                },
                {
                    "relation": "child",
                ...
                },
                {
                    ...
                    "qualifiers": {
                        "position played on team/speciality": [
                            {"type": "string", "value": "small forward"}
                        ],
                        "sport number": [
                            {"type": "quantity", "value": 23, "unit": "1"}
                        ],
                    },
                },
            ],
            ...
            "attributes": [
                {
                    ...
                    "qualifiers": {"point in time": [{"type": "year", "value": 2010}]},
                }
            ],
            "relations": [],
        },
        ...
        "Q22302425": {
            ...
            "attributes": [
                {
                    "key": "height",
                    "value": {"type": "quantity", "value": 188, "unit": "centimetre"},
                    "qualifiers": {},
                },
                {
                    "key": "sex or gender",
                ...
                {
                    "key": "date of birth",
                    "value": {"type": "date", "value": "2004-10-06"},
                    "qualifiers": {},
                },
            ],
            "relations": [
...
class TestExample(unittest.TestCase):
    ...
    def test_SelectBetween(self):
        ans = engine.SelectBetween(
            ...
            engine.Relate(
                engine.Find("LeBron James Jr."), relation="father", direction="forward"
            ),
            key="height",
            op="greater",
        )
    ...
    def test_SelectAmong(self):
        ans = engine.SelectAmong(
            engine.Or(engine.Find("LeBron James"), engine.Find("LeBron James Jr.")),
            key="height",
            op="largest",
        )
        self.assertEqual(ans, ["LeBron James"])
    ...
    def test_QueryAttr(self):
        ans = engine.QueryAttr(entities=engine.Find("LeBron James"), key="height")
    ...
    def test_FilterConcept(self):
        ...
        ans = engine.FilterConcept(
            entities=engine.Find("Cleveland Cavaliers"), concept_name="basketball team"
        )
    ...
    def test_FilterNum(self):
        ans = engine.FilterNum(
            entities=engine.FilterConcept(
                entities=engine.FindAll(), concept_name="basketball player"
            ),
            key="height",
    ...
    def test_VerifyStr(self):
        ans = engine.VerifyStr(
            s_value=engine.QueryAttr(
                entities=engine.Find("LeBron James"), key="sex or gender"
            ),
            t_value="male",
        )
    ...
    def test_VerifyNum(self):
        ans = engine.VerifyNum(
            s_value=engine.QueryAttr(
                entities=engine.Find("LeBron James"), key="height"
            ),
    ...
    def test_VerifyDate(self):
        ans = engine.VerifyDate(
            s_value=engine.QueryAttr(
                entities=engine.Find("LeBron James"), key="date of birth"
            ),
            t_value="1984-12-30",
            op="=",
        )
